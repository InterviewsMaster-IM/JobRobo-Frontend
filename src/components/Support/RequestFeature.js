...
const RequestFeature = ({ handleSupportModalClose }) => {
            ...
            <Grid container item padding={'12px 24px'} display={'flex'} flexDirection={'column'} gap={'8px'}>
                <Grid container item display={'flex'} flexDirection={'column'} gap={'8px'}>
                    <Typography variant='body2' fontSize={'12px'} fontWeight={'600'}>
                        What feature would you like on JobRobo?
                    </Typography>
                    <TextField
                        fullWidth
                        name='feature'
                        ...
                        placeholder="I want a new feature that does...&#10;Everything begins with an idea and no idea is too small!"
                        multiline
                        required
                        rows={6}
                    />
