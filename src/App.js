...
import ResumeQuestionsTests from './pages/resumeQuestionsTest';import AccountSettings from './pages/AccountSettings';
        ...
        <AuthProvider>
            <Router>
                <Routes>
                    ...
                    <Route path="/settings" element={<ProtectedRoute component={AccountSettings}></ProtectedRoute>}  />
